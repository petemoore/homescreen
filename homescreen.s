...
.set GPU_START,        0x3c000000         // First byte of shared GPU memory. Note, if we support other RPI models later, we'll need to set this based on the model. This also assumes 64MB gpu.
                                          // TODO: We should get this from https://github.com/raspberrypi/firmware/wiki/Mailbox-property-interface#get-arm-memory
...
# from R0_0137:
  ...
  mov     x14, GPU_START                  // x14 = first byte of shared GPU memory, for determining where CPU dedicated RAM ends (one byte below).
